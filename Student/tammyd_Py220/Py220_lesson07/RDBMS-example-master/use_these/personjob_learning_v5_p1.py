...
def populate_db():
    ...
    jobs = [
        ...
        ('Senior business analyst', '2006-10-23', '2016-12-24', 80000, 'Andrew', 'A001'),
        ('Admin supervisor', '2012-10-01', '2014-11,10', 45900, 'Peter', 'B002'),
        ('Admin manager', '2014-11-14', '2018-01,05', 45900, 'Peter', 'B002')
        ]
