...
This is an object oriented version of mailroom.
Class example to be used with lesson07 assignment.

"""

# ???. Seeking clarity on the lines to update in this code. Mostly handled in my populate_db.py, mailroom.db and mailroom_model.py files. 
...
def get_sample_data():
    ...
    """
    return [Donor("Britney Spears", [653772.32, 12.17]),
            Donor("Mandy Moore", [877.33]),
            Donor("Christina Aguilera", [663.23, 43.87, 1.32]),
            Donor("Queen Bey", [1663.23, 4300.87, 10432.0]),
            ]
