...
def login_mongodb_cloud():
    ...
    client = pymongo.MongoClient(f'mongodb://tammytdo:9*MongoDB@cluster0-shard-00-00-7ak2y.mongodb.net:27017,cluster0-shard-00-01-7ak2y.mongodb.net:27017,cluster0-shard-00-02-7ak2y.mongodb.net:27017/test?ssl=true&replicaSet=Cluster0-shard-0&authSource=admin&retryWrites=true')
