...
def run_example():
    ...
    try:
        ...
        log.info('Add some customer data to the cache')
        r.set('Cara', '209-234-9878', '98023')
        r.set('Ellen', '234-098-1234', '98072')
        r.set('Suki', '298-987-3456', '98098')
        r.set('Chris', '234-976-7765', '98091')
        r.set('Nate', '298-785-3989', '98017')
        r.set('Katy', '240-897-6656', '98055')

        #retrieve a zip code and then a phone number for a known customer
        log.info('retrieve a zip code and then a phone number for Ellen')
        print(f"Ellen's zipcode is {r.lindex('Ellen', 1)} and phone number is {r.lindex('Ellen', 0)}")
